...
//		matr2.createMatrixA(4000, 4000, 10);
//		matr2.createMatrixB(4000, 4000, 10);
...
//		int numOfthread = 2;
//		for(int i = 0; i < 6;i++) {
//			ParallelMatrixMul matr = new ParallelMatrixMul(numOfthread);
//			for(int j = 0; j < 2;j++) {
//				matr.createMatrixA(numb1, numb1, 10);
//				matr.createMatrixB(numb1, numb1, 10);
//				startTime = System.currentTimeMillis();	
//
//				matr.parallelMultMatrixsAB();
//				endTime = System.currentTimeMillis();
//				System.out.println("Total execution time: " + (endTime-startTime) + "ms numOfthread "+ numOfthread); 
//	
//			}
//			if(i < 3) {
//				numOfthread++;
